	...
	var document = window.document,
		...
		renderTopButtons = function(opts) {
			return (
				...
				'' +
				'<button type="button" id="lightpick__previous-action" class="lightpick__previous-action">' +
				opts.locale.buttons.prev +
				'</button>' +
				'<button type="button" id="lightpick__next-action" class="lightpick__next-action">' +
